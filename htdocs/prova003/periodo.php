      ...
      <div class="row" >
        ...
        <div class="col-md-7">
          <ul class="nav justify-content-end">
            ...
            <li class="nav-item">
              <a class="nav-link active text-white" aria-current="page" href="disciplinas.php">Disciplinas</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
          <?php
              echo '<h1>listagem Período</h1>';
                ...
                $sql = mysql_query("SELECT id, nome, date_format(data_de_inicio, '%d/%m/%Y') as inicio, date_format(data_de_termino, '%d/%m/%Y') as termino, situacao FROM periodos where nome like '%$nome%'");
                ...
                while ($linha = mysql_fetch_array($sql)){
                    ...
                    echo" 
                     ...
                     <td>
                     <a href='deletar.php?id1=$linha[id]' class='btn btn-warning' onclick=\"return confirm('Deseja excluir?');\">Deletar</a>
                     <a href='formulario_editar_periodo.php?id=$linha[id]' class='btn btn-danger'>Editar</a>
                     </td>
                     </tr>
                ...
                echo '</table> <br>'; 
                echo "<a href='formulario_inserir_periodo.php' ><button type='submit' class='btn btn-primary me-5'>Novo cadastro</button></a>";
                echo"<a href='periodo.php' class='btn btn-primary me-5'><i class='fas fa-sync-alt'></i></a>";
