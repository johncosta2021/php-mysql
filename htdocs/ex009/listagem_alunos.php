...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
          ...
          //  // $banco = "SELECT a.id id_aluno, a.nome nome_aluno, cpf, matricula, 
          //  b.id id_cursos, b.nome nome_curso, vagas, 
          //  DATE_FORMAT(NASCIMENTO, '%d/%m/%Y') AS nasc_novo,
          //  IF (b.nome IS NULL,'--Sem curso--',b.nome) nome_curso
          //  FROM alunos a 
          //  LEFT JOIN cursos b ON a.id_cursos=b.id
          //  WHERE nome LIKE \"%$nome_aluno%\"
          //  ORDER BY a.id ASC";
             $banco = "SELECT a.id id_aluno,a.nome nome_aluno,matricula,cpf,c.id id_curso,IF (c.nome IS NULL,'<strong>sem curso</strong>',c.nome) nome_curso,vagas, DATE_FORMAT (nascimento,'%d/%m/%Y') AS nasc_novo FROM alunos a left JOIN cursos c ON a.id_curso=c.id WHERE a.nome LIKE'%$nome%' ORDER BY id_aluno;";
          ...
          echo"<div class='table-responsive'> ";  
            ...
            while ( $linha = mysql_fetch_array($sql)){
                 ...
                 <tr class='text-center'>
                    ...
                    <td> 
                    <a href='deletar.php?id=$linha[id_aluno]' class='btn btn-danger'
                    onclick=\"return confirm('Deseja excluir?');\">Excluir</a> 
                    
                    <a href='formulario_editar.php?id=$linha[id_aluno]' class='btn btn-warning' >Editar</a></td>
                 </tr>";
                 $c+=1;
            }
                echo "</table> ";
