...
<html lang="pt-br">
  ...
  <?php 
    ...
    //  $sql= "SELECT a.id_curso linha,a.id id_aluno,a.nome nome_aluno, matricula, cpf,c.id id_curso,c.nome nome_curso,nascimento FROM alunos a left JOIN cursos c ON a.id_curso=c.id  WHERE a.id='$id'";
