...
<html lang="en">
  <head>
    ...
    <style>
      .cor1{ background-color: #eeeff2; box-shadow: 0px -4px 1px blue; }
      .a1{ margin-right: 2em; }
    </style>

    <title>UFPI-CTT</title>
  </head>
  <body>
          <header>
              ...
              <div class="row" >
                ...
                <div class="col-md-7">
                  <ul class="nav justify-content-end">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-white" href="listagem_alunos.php">Alunos</a>
                    </li>
                    <li class="nav-item">
        ...
        <div  class="row">
              <div class="col-md-2">
                    <div class="list-group">
                      ...
                      <a href="#" class="list-group-item list-group-item-action">Técnico</a>
                      <a href="#" class="list-group-item list-group-item-action">Graduação</a>
                      <a href="#" class="list-group-item list-group-item-action">Pós-Graduação</a>
                      <a href="#" class="list-group-item list-group-item-action">Ensino a distância</a>
                    </div>
              </div>
        </div>
    </div> -->
