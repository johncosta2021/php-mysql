...
<html lang="pt-br">
  ...
  <body>
	...
	<div class="container">
		<h1>Formulário de inserir alunos</h1>
		<form method="POST" action="inserir.php">
			Nome <br>
			<input type="text" name="nome" class="form-control" required placeholder="Digite seu nome aqui">
			<br>
			CPF <br>
			<input type="text" name="cpf" id="cpf" class="form-control" required placeholder="Digite seu CPF aqui">
			<br>
			Matrícula<br>
			<input type="text" name="matricula" class="form-control" required placeholder="Digite a sua matricula aqui">
			<br>
			Nascimento<br>
