  ...
  <body>
    ...
    <div class="container">
        ...
        <form action="inserir.php" method="POST">
          ...
          <br>
          CPF: <br>
          <input type="text" name="cpf" id="cpf1" minlength="14" maxlength="14" class="form-control" placeholder="ex: 999.999.999-99" id="cpf" onkeypress="mascara_cpf()" autocomplete="off">
          <br>
          Matricula: <br>
